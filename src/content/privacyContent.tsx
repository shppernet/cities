...
export const policyContent = {
  en: {
    ...
    generalInfo: {
      terms: [
        "We respect your privacy and are committed to protecting it through our compliance with this privacy policy (“Policy”). This Policy describes the types of information we may collect from you or that you may provide (“Personal Information”) on the shpper.net website (“Website”), “Shpper” mobile application (“Mobile Application”), and any of their related products and services (collectively, “Services”), and our practices for collecting, using, maintaining, protecting, and disclosing that Personal Information. It also describes the choices available to you regarding our use of your Personal Information and how you can access and update it.",
        "This Policy is a legally binding agreement between you (“User”, “you” or “your”) and Shpper Software Design FZCO (doing business as “Shpper”, “we”, “us” or “our”). If you are entering into this Policy on behalf of a business or other legal entity, you represent that you have the authority to bind such entity to this Policy, in which case the terms “User”, “you” or “your” shall refer to such entity. If you do not have such authority, or if you do not agree with the terms of this Policy, you must not accept this Policy and may not access and use the Services. By accessing and using the Services, you acknowledge that you have read, understood, and agree to be bound by the terms of this Policy. This Policy does not apply to the practices of companies that we do not own or control, or to individuals that we do not employ or manage.",
      ],
    },
    ...
    GDPRImportantInfo: {
      ...
      lists: [
        ...
        {
          description: "Fulfill and manage orders",
        },
        {
          description: "  Deliver products or services",
        },
        {
          description: " Improve products and services",
        },
        {
          description: " Send administrative information",
        },
        {
          description: "Send marketing and promotional communications",
        },
        {
          description: "Send product and service updates",
        },
        {
          description: "Respond to inquiries and offer support",
        },
        {
        ...
        {
          description: "Post customer testimonials",
        },
        {
          description: "Deliver targeted advertising",
        },
        {
          description: "Administer prize draws and competitions",
        },
        {
          description: "Enforce terms and conditions and policies",
        },
        {
          description: "Protect from abuse and malicious users",
        },
        {
          description: "Respond to legal requests and prevent harm",
        },
        {
          description: "Run and operate the Services",
        },
      ],
      conclusion: [
    ...
    processNCollectInfo: {
      description: [
        "We rely on the following legal bases upon which we collect and process your Personal Information:",
      ],
      ...
      lists: [
        ...
        {
          description: "Compliance with the law and legal obligations",
        },
        {
          description: "  Our own legitimate interests",
        },
      ],
      conclusion: [
    ...
    DiscloseInfo: {
      ...
      lists: [
        ...
        {
          description: "Order fulfillment services",
        },
        {
          description: "Payment processors",
        },
        {
          description: "Performance monitoring services",
        },
        {
    ...
    RegionInfo: {
      ...
      lists: [
        {
          description: "Disclosures for residents of Australia",
        },
      ],
      conclusion: [
    ...
    AusRegionList: {
      ...
      lists: [
        {
          topic: "Right to access and correct: ",
          description:
            "You have the right to access Personal Information we hold about you. You also have the right to request corrections to your Personal Information if you think the information is inaccurate, out-of-date, incomplete, irrelevant or misleading.",
        },
        {
          topic: "Right to restrict processing: ",
          description:
            "You can request that we stop or restrict the processing of your Personal Information in certain circumstances, such as when you contest the accuracy of your data.",
        },
        {
          topic: "Right to data portability: ",
          description:
            " You have the right to request the transfer of your Personal Information to a different service provider as long as it is technically possible to do so or directly to you.",
        },
        {
          topic: "Right to not be subject to automated decision-making: ",
          description:
            "  You have the right to opt out of decisions based solely on automated processing of your Personal Information, particularly when these decisions have legal or similarly significant effects on you.",
        },
        {
          topic: "Right to anonymity: ",
          description:
            " You are generally able to use a pseudonym or remain anonymous when interacting with us. However, in some circumstances, you may have to provide certain Personal Information. For example, we may require Personal Information to assess your eligibility for a program or service. We will inform you if you are not able to remain anonymous or use a pseudonym when dealing with us.",
        },
      ],
    },
    BraRegionInfo: {
      lists: [
        {
          description: " Disclosures for residents of Brazil",
        },
      ],
      conclusion: [
    ...
    BraRegionList: {
      ...
      lists: [
        {
          topic: "Right to know and access: ",
          description:
            " You have the right to confirm whether we process your Personal Information and, if so, access it. This ensures you are fully informed about the data we hold and how it's used.",
        },
        {
          topic: "Right to correct: ",
          description:
            "You have the right to correct Personal Information if you find any of it in our possession to be incorrect or outdated as we are committed to maintaining the accuracy and relevance of your Personal Information.",
        },
        {
          topic: "Right to anonymize and block: ",
          description:
            " You can request the anonymization or blocking of Personal Information that is unnecessary, excessive, or not processed in compliance with the LGPD.",
        },
        {
          topic: "Right to data portability: ",
          description:
            "You have the right to transfer your data to another service provider or product supplier, promoting your freedom to choose services without losing your data history.",
        },
        {
          topic: " Right to delete: ",
          description:
            "If we have processed your data based on consent, you can request its deletion, except where law requires or permits us to retain it.",
        },
        {
          topic: "Right to information about third parties:",
          description:
            " You can ask about the third parties with whom we share your data, ensuring transparency in our data sharing practices.",
        },
        {
          topic: "Right to information on consent denial: ",
          description:
            "You can withdraw your consent for data processing at any time to ensure control over your Personal Information.",
        },
        {
          topic: "Right to withdraw consent:",
          description:
            " You can withdraw your consent for data processing at any time to ensure control over your Personal Information.",
        },
        {
          topic: "Right to review automated decisions: ",
          description:
            "You can request a review of decisions made solely based on automated processing of your data to ensure fairness and accuracy in processes that significantly impact you.",
        },
      ],
    },
    CanRegionInfo: {
      lists: [
        {
          description: "Disclosures for residents of Canada",
        },
      ],
      conclusion: [
      ...
      lists: [
        {
          ...
          description:
            " You have the right to access the Personal Information we hold about you if you wish to review, verify, or correct your information.",
        },
        {
          topic: "Right to correct: ",
          description:
            "We strive to maintain the accuracy of your Personal Information and will promptly make necessary corrections when you identify inaccuracies in your data.",
        },
        {
          topic: " Right to withdraw consent:",
          description:
            "You can withdraw your consent regarding the handling of your Personal Information at any time, subject to legal or contractual limitations.",
        },
        {
          topic: "Right to complain:",
          description:
            "You have the right to file a complaint with the Privacy Commissioner of Canada if you feel your Personal Information is being handled in a way that violates PIPEDA.",
        },
        {
          topic: "Right to challenge compliance: ",
          description:
            "If we have processed your data based on consent, you can request its deletion, except where law requires or permits us to retain it.",
        },
        {
          topic: "Right to know about breaches: ",
          description:
            "You have the right to be notified in cases of a security breach involving your Personal Information that poses a real risk of significant harm.",
        },
      ],
    },
    EURegionInfo: {
      lists: [
        {
          description: " Disclosures for residents of the EU/EEA and the UK",
        },
      ],
      conclusion: [
    ...
    EURegionList: {
      ...
      lists: [
        ...
        {
          topic: " Right to object to the processing: ",
          description:
    ...
    NeaRegionInfo: {
      lists: [
        {
          description: " Disclosures for residents of New Zealand",
        },
      ],
      conclusion: [
      ...
      lists: [
        {
          topic: "Right to Access: ",
          description:
            "You have the right to access your Personal Information that we hold, enabling you to review and understand the data we have about you for transparency and accuracy.",
        },
        {
          topic: " Right to Correction:  ",
          description:
            "If your Personal Information is incorrect or outdated, you have the right to request its correction, ensuring that the information we hold is accurate and up-to-date.",
        },
        {
          topic: "Right to Make a Complaint: ",
          description:
            "If you believe your privacy rights have been breached, you have the right to make a complaint to a data protection authority.",
        },
        {
          topic: " Right to Object to Automated Decision-making:  ",
          description:
            " You can object to decisions made solely on automated processing of your Personal Information that have significant effects on you, ensuring a fair and transparent decision-making process.",
        },
        {
          topic: " Right to Data Portability:  ",
          description:
            "Where applicable, you have the right to request the transfer of your Personal Information to another service provider if technically possible or directly to you.",
        },
        {
          topic: "Right to Anonymity and Pseudonymity: ",
          description:
            "Where possible, you have the option to interact with us without revealing your identity or by using a pseudonym, offering flexibility and control over your personal engagement.",
        },
        {
          topic: " Notification of Data Breaches:  ",
          description:
            "In the event of a data breach that may harm your privacy, we will notify you promptly, taking immediate steps to mitigate any potential impacts.",
        },
      ],
    },
    USARegionInfo: {
      lists: [
        {
          description: "Disclosures for residents of the USA",
        },
      ],
      conclusion: [
    ...
    USARegionList: {
      ...
      lists: [
        {
          topic: "Right to know and right to access: ",
          description:
            "You have the right to request certain information we have collected about you. Once we receive and confirm a verifiable request from you, we will disclose to you, to the extent permitted by law:",
          subLists: [
            {
              description:
        ...
        {
          topic: "Right to opt-out of the sale and sharing:",
          description:
            "You have the right to opt-out of the sale of your Personal Information which may include selling, disclosing, or transferring Personal Information to another business or a third party for monetary or other valuable consideration.",
        },
        {
          topic:
            "Right to consent to or limit the use of your sensitive personal information: ",
          description:
            "You have the right to consent to the use of your Sensitive Personal information and to direct us to restrict its use and disclosure solely to what is essential for carrying out or delivering the Services in a manner reasonably anticipated by an average user, or for certain business objectives as specified by law. However, we do not use Sensitive Personal Information for any purposes other than those legally permitted or beyond the scope of your consent.",
        },
        {
          topic: "Right to non-discrimination: ",
          description:
            " You have the right to not be discriminated against in the Services or quality of Services you receive from us for exercising your rights. We may not, and will not, treat you differently because of your data subject request activity, and we may not and will not deny goods or Services to you, charge different rates for goods or Services, provide a different level quality of goods or Services, or suggest that we would treat you differently because of your data subject request activity.",
        },
        {
          topic: "Shine the Light: ",
          description:
            "California residents that have an established business relationship with us have the right to know how their personal information is disclosed to third parties for their direct marketing purposes under California’s “Shine the Light” law, or the right to opt out of such practices.",
        },
      ],
      conclustion: [
    ...
    childrenPrivacyInfo: {
      ...
      terms: [
        "We do not knowingly collect any Personal Information from children under the age of 13. If you are under the age of 13, please do not use or services and do not submit any Personal Information through the Services. If you have reason to believe that a child under the age of 13 has provided Personal Information to us through the Services, please contact us to request that we delete that child’s Personal Information from our Services.",
    ...
    AdvertisementsInfo: {
      ...
      terms: [
        ...
        "You may also download the AppChoices app at Digital Advertising Alliance’s AppChoices app to opt out in connection with mobile apps, or use the platform controls on your mobile device to opt out.",
      ],
    },
    SocialMediaInfo: {
      title: "Social media features",
      terms: [
        "Our Services may include social media features, such as the Facebook and X buttons, Share This buttons, etc (collectively, “Social Media Features”). These Social Media Features may collect your IP address, what page you are visiting on our Services, and may set a cookie to enable Social Media Features to function properly. Social Media Features are hosted either by their respective providers or directly on our Services. Your interactions with these Social Media Features are governed by the privacy policy of their respective providers.",
      ],
    },
    EmailMarketing: {

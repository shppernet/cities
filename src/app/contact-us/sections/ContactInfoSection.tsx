  ...
  return (
    <div className="flex h-full  justify-start bg-white pt-30 mt-auto">
      <div className="mx-auto w-full max-w-2xl  p-2 sm:p-6 flex flex-col justify-center items-center gap-3  ">
        ...
        <p>
          Got questions, feedback, or assistance? We&apos;d love to hear from
          you.
        </p>

        <p>Reaching us is just an email away.</p>

        <p className="pt-10">
          For any inquiries, support needs, or just to say hello, Don&apos;t
